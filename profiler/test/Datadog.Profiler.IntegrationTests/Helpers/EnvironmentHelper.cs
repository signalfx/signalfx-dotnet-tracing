...
namespace Datadog.Profiler.IntegrationTests.Helpers
{
    public class EnvironmentHelper
    {
        ...
        internal void PopulateEnvironmentVariables(StringDictionary environmentVariables, int agentPort, int profilingExportIntervalInSeconds, string serviceName)
        {
            ...
            environmentVariables["SIGNALFX_TRACE_ENABLED"] = "0";
        ...
        {
            CustomEnvironmentVariables["SIGNALFX_TRACE_ENABLED"] = "1";
            CustomEnvironmentVariables["SIGNALFX_DOTNET_TRACER_HOME"] = GetTracerHomeDirectory();
        }
