...
| `SIGNALFX_GLOBAL_TAGS` | Comma-separated list of key-value pairs that specify global tags added to all telemetry signals. For example: `"key1:val1,key2:val2"`. If not set, value of `SIGNALFX_TRACE_GLOBAL_TAGS` is used if set. |  |
