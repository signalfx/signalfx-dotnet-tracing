...
#ifdef _WIN32
const WSTRING native_dll_filename = WStr("SIGNALFX.TRACING.CLRPROFILER.NATIVE.DLL");
#elif MACOS
const WSTRING native_dll_filename = WStr("SignalFx.Tracing.ClrProfiler.Native.dylib");
#else
