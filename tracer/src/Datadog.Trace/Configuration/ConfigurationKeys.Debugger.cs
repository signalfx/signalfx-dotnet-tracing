...
namespace Datadog.Trace.Configuration
{
    internal static partial class ConfigurationKeys
    {
        internal static class Debugger
        {
            ...
            public const string PollInterval = "SIGNALFX_DEBUGGER_POLL_INTERVAL";

            /// <summary>
            /// Configuration key for the URL used to query our backend directly for the list of active probes.
            /// This can only be used if SIGNALFX_API_KEY is also available.
            /// </summary>
            /// <seealso cref="DebuggerSettings.ProbeConfigurationsPath"/>
            public const string SnapshotUrl = "SIGNALFX_DEBUGGER_SNAPSHOT_URL";
            ...
            /// </summary>
            /// <seealso cref="DebuggerSettings.ProbeConfigurationsPath"/>
            public const string ProbeFile = "SIGNALFX_DEBUGGER_PROBE_FILE";
            ...
            public const string Enabled = "SIGNALFX_INTERNAL_DEBUGGER_ENABLED";
            ...
            public const string MaxDepthToSerialize = "SIGNALFX_DEBUGGER_MAX_DEPTH_TO_SERIALIZE";
            ...
            public const string MaxTimeToSerialize = "SIGNALFX_DEBUGGER_MAX_TIME_TO_SERIALIZE";
            ...
            public const string UploadBatchSize = "SIGNALFX_DEBUGGER_UPLOAD_BATCH_SIZE";
            ...
            public const string DiagnosticsInterval = "SIGNALFX_DEBUGGER_DIAGNOSTICS_INTERVAL";
            ...
            public const string UploadFlushInterval = "SIGNALFX_DEBUGGER_UPLOAD_FLUSH_INTERVAL";
        }
    }
}
