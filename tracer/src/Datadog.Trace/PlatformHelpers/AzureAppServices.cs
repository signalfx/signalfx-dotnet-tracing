...
namespace Datadog.Trace.PlatformHelpers
{
    ...
    internal class AzureAppServices
    {
        ...
        /// </summary>
        internal const string AzureAppServicesContextKey = "SIGNALFX_AZURE_APP_SERVICES";
        ...
        /// </summary>
        internal const string SiteExtensionVersionKey = "SIGNALFX_AAS_DOTNET_EXTENSION_VERSION";
        ...
        /// </summary>
        public const string AasEnableCustomTracing = "SIGNALFX_AAS_ENABLE_CUSTOM_TRACING";

        /// <summary>
        /// Used to force the loader to start dogstatsd (in case automatic instrumentation is disabled)
        /// </summary>
        public const string AasEnableCustomMetrics = "SIGNALFX_AAS_ENABLE_CUSTOM_METRICS";
