...
namespace Datadog.Trace
{
    ...
    public class Tracer : ITracer, IDatadogTracer, IDatadogOpenTracingTracer
    {
        ...
        internal Span StartSpan(string operationName, ITags tags = null, ISpanContext parent = null, string serviceName = null, DateTimeOffset? startTime = null, TraceId? traceId = null, ulong? spanId = null, string rawTraceId = null, string rawSpanId = null, bool addToTraceContext = true)
        {
            ...
            // automatically add the "deployment.environment" tag if defined, taking precedence over an "env" tag set from a global tag
        ...
        private static void RegisterGlobalTracer(Tracer instance)
        {
            ...
            var signalFxOpenTracingAssembly = Assembly.Load(new AssemblyName("SignalFx.Tracing.OpenTracing, Version=0.2.10.0, Culture=neutral, PublicKeyToken=e43a27c2023d388a"));
