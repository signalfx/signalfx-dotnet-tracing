...
namespace Datadog.Trace
{
    ...
    public class Tracer : ITracer, IDatadogTracer, IDatadogOpenTracingTracer
    {
        ...
        private static void RegisterGlobalTracer(Tracer instance)
        {
            ...
            var signalFxOpenTracingAssembly = Assembly.Load(new AssemblyName("SignalFx.Tracing.OpenTracing, Version=1.1.1.0, Culture=neutral, PublicKeyToken=e43a27c2023d388a"));
