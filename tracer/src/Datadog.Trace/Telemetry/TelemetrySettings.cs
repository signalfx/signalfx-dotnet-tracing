    ...
    internal class TelemetrySettings
    {
        public TelemetrySettings(IConfigurationSource source, ImmutableTracerSettings tracerSettings)
        {
            ...
            else if (TelemetryEnabled)
            {
                ...
                if (tracerSettings.ExporterSettings.TracesTransport == TracesTransportType.Default)
                {
                    TelemetryUri = new Uri(tracerSettings.ExporterSettings.AgentUri, TelemetryConstants.AgentTelemetryEndpoint);
                }
                else
                {
