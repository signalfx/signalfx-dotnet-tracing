    ...
    internal class ConfigurationTelemetryCollector
    {
        ...
        public ICollection<TelemetryValue> GetConfigurationData()
        {
            ...
            var data = new List<TelemetryValue>(_azureApServicesMetadata.IsRelevant ? 21 : 17)
            {
                ...
                new(ConfigTelemetryData.AgentUrl, value: settings.ExporterSettings.AgentUri.ToString()),
                new(ConfigTelemetryData.AgentTraceTransport, value: settings.ExporterSettings.TracesTransport.ToString()),
