        ...
        protected void CheckForSmoke(bool shouldDeserializeTraces = true)
        {
            ...
            using (var agent = EnvironmentHelper.GetMockAgent())
            {
                ...
                using (var process = new Process())
                {
                    ...
                    EnvironmentHelper.SetEnvironmentVariables(agent, aspNetCorePort, statsdPort: null, logsCollectorPort: null, process.StartInfo.EnvironmentVariables, processToProfile: executable);
