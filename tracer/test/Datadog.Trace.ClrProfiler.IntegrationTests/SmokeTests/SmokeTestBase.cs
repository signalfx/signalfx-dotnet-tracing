        ...
        protected void CheckForSmoke(bool shouldDeserializeTraces = true, int expectedExitCode = 0)
        {
            ...
            using (var agent = EnvironmentHelper.GetMockAgent())
            {
                ...
                using (var process = new Process())
                {
                    ...
                    EnvironmentHelper.SetEnvironmentVariables(agent, aspNetCorePort, logsCollectorPort: null, process.StartInfo.Environment, processToProfile: executable, useDatadogExporter: true);
