...
public class LiveDebuggerTests : TestHelper
{
    ...
    private const string LiveDebuggerDisabledLogEntry = "Live Debugger is disabled. To enable it, please set SIGNALFX_DEBUGGER_ENABLED environment variable to 'true'.";
