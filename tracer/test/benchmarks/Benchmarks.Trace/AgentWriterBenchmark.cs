...
namespace Benchmarks.Trace
{
    ...
    public class AgentWriterBenchmark
    {
        ...
        static AgentWriterBenchmark()
        {
            ...
            var api = new Api(settings.ExporterSettings.AgentUri, new FakeApiRequestFactory(), statsd: null, updateSampleRates: null, isPartialFlushEnabled: false);
            ...
            {
                enrichedSpans[i] = new Span(new SpanContext(TraceId.CreateFromInt(i), (ulong)i, SamplingPriorityValues.UserReject, "Benchmark", null), now);
