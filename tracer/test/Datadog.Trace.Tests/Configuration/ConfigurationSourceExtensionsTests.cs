...
namespace Datadog.Trace.Tests.Configuration
{
    public class ConfigurationSourceExtensionsTests
    {
        ...
        {
            yield return new object[] { new NameValueCollection { { "example1", "value1" } }, "example2", Array.Empty<TestEnum>() };
            yield return new object[] { new NameValueCollection { { "example1", "value1" } }, "example1", Array.Empty<TestEnum>() };
