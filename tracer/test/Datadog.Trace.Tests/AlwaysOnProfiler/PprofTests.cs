...
namespace Datadog.Trace.Tests.AlwaysOnProfiler
{
    public class PprofTests
    {
        ...
        public void AddLabel()
        {
            ...
            _pprof.AddLabel(sampleBuilder, "ulong", 100UL);
            _pprof.AddLabel(sampleBuilder, "bool", true);
            _pprof.AddLabel(sampleBuilder, "long", 32132L);
            ...
            sample.Labels.Should().Contain(pair => pair.Key == 1 && pair.Num == -9223372036854775708L);
            ...
            profile.StringTables.Should().ContainInOrder(new List<string> { string.Empty, "ulong", "bool", "True", "long", "string", "value" });
        }
