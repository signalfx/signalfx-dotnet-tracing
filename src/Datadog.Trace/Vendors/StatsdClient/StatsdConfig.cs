...
namespace SignalFx.Tracing.Vendors.StatsdClient
{
    internal class StatsdConfig
    {
        ...
        public const string DD_ENTITY_ID_ENV_VAR = "SIGNALFX_ENTITY_ID";
        public const string DD_DOGSTATSD_PORT_ENV_VAR = "SIGNALFX_DOGSTATSD_PORT";
        public const string DD_AGENT_HOST_ENV_VAR = "SIGNALFX_AGENT_HOST";
