...
namespace Datadog.AutoInstrumentation.ManagedLoader
{
    ...
    /// of the product home directory in addition to the normal probing paths (e.g. SIGNALFX_DOTNET_TRACER_HOME for the Tracer).
...
#pragma warning restore IDE0079  // Remove unnecessary suppression
        ...
        private static void GetTracerManagedBinariesDirectories(List<string> binaryDirs)
        {
            ...
            string tracerHomeDirectory = ReadEnvironmentVariable("SIGNALFX_DOTNET_TRACER_HOME");
