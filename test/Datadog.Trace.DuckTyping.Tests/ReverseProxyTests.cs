...
namespace SignalFx.Tracing.DuckTyping.Tests
{
    ...
    {
        [Fact(Skip = "Currently broken test")]
        public void PrivateInterfaceReverseProxyTest()
        {
            Type iLogEventEnricherType = typeof(SignalFx.Tracing.Vendors.Serilog.Core.ILogEventEnricher);
        ...
        public void PrivateAbstractClassReverseProxyTest()
        {
            ...
            var type = typeof(SignalFx.Tracing.Vendors.Serilog.Events.LogEventPropertyValue);
#if NET452
            Assert.Throws<DuckTypeTypeIsNotPublicException>(() =>
            {
            ...
            ((SignalFx.Tracing.Vendors.Serilog.Events.LogEventPropertyValue)proxy2).ToString("Hello world", null);
