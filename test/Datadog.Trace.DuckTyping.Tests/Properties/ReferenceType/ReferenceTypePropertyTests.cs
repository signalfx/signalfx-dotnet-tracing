...
using SignalFx.Tracing.DuckTyping.Tests.Properties.ReferenceType.ProxiesDefinitions;
using Xunit;

namespace SignalFx.Tracing.DuckTyping.Tests.Properties.ReferenceType
{
